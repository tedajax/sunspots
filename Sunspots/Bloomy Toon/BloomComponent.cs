...
namespace StarForce_PendingTitle_
{
    public class BloomComponent : DrawableGameComponent
    {
        ...
        public bool calleddrawalready = false;
        ...
        protected override void LoadContent()
        {
            ...
            bloomExtractEffect = Game.Content.Load<Effect>("Content\\Effects\\BloomExtract");
            bloomCombineEffect = Game.Content.Load<Effect>("Content\\Effects\\BloomCombine");
            gaussianBlurEffect = Game.Content.Load<Effect>("Content\\Effects\\GaussianBlur");
