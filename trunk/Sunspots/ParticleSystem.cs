...
namespace StarForce_PendingTitle_
{
    ...
    /// </summary>
    public abstract class ParticleSystem3D : GameComponent
    {
        #region Fields
        ...
        /// Constructor.
        /// </summary>
        protected ParticleSystem3D(Game game, ContentManager content)
            : base(game)
        {
        ...
        public override void Initialize()
        {
            ...
            vertexDeclaration = new VertexDeclaration(WindowManager.graphicsDeviceService.GraphicsDevice,
                                                      ParticleVertex.VertexElements);

            // Create a dynamic vertex buffer.
            int size = ParticleVertex.SizeInBytes * particles.Length;

            vertexBuffer = new DynamicVertexBuffer(WindowManager.graphicsDeviceService.GraphicsDevice, size,
        ...
        void LoadParticleEffect()
        {
            ...
            particleEffect = effect.Clone(WindowManager.graphicsDeviceService.GraphicsDevice);
            ...
            Texture2D texture = content.Load<Texture2D>("Content\\" + settings.TextureName);
        ...
        {
            GraphicsDevice device = WindowManager.graphicsDeviceService.GraphicsDevice;
